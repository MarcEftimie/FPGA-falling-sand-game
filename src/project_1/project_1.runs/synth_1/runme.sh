...
HD_PWD='/home/marc/projects/FPGA_Falling_Sand_Game/src/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mouse_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mouse_led.tcl
