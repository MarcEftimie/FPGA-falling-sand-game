...
HD_PWD='/home/marc/projects/FPGA_Falling_Sand_Game/src/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mouse_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mouse_led.tcl -notrace
